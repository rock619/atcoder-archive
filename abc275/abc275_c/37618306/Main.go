...
func Distance2(a, b int) int {
	return Distance(a%9, a/9, b%9, b/9)
}

func Empty(S [][]byte, a int) bool {
	return S[a/9][a%9] == '.'
}
		...
		for j := i + 1; j <= 80; j++ {
			...
			for k := j + 1; k <= 80; k++ {
				...
				for l := k + 1; l <= 80; l++ {
					...
					ab := Distance2(i, j)
					if ab == Distance2(i, k) && ab == Distance2(j, l) && ab == Distance2(k, l) && Distance2(i, l) == Distance2(j, k) {
						m[1000000*i+10000*j+100*k+l] = struct{}{}
					}
				}
			}
		}
