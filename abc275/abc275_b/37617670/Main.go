...
func solve(o, lg Printer, A int, B int, C int, D int, E int, F int) {
	result := SafeMod(A, mod)
	result = SafeMod(result*SafeMod(B, mod), mod)
	result = SafeMod(result*SafeMod(C, mod), mod)
	sub := SafeMod(D, mod)
	sub = SafeMod(sub*SafeMod(E, mod), mod)
	sub = SafeMod(sub*SafeMod(F, mod), mod)
	o.l(SafeMod(result-sub, mod))
}
