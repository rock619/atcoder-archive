...
type LazySegTree struct {
	...
	op          func(a, b S) S
	e           func() S
	mapping     func(l F, r S) S
	composition func(l, r F) F
	id          func() F
}
...
func solve(N, Q int64, a []int64, queries []Query) {
	...
	lst := NewLazySegTree(
		func(l, r S) S { return S{A: (l.A + r.A) % mod, Size: l.Size + r.Size} },
		func() S { return S{} },
		func(l F, r S) S { return S{A: (r.A*l.A%mod + r.Size*l.B%mod) % mod, Size: r.Size} },
		func(l, r F) F { return F{A: r.A * l.A % mod, B: (r.B*l.A%mod + l.B) % mod} },
		func() F { return F{A: 1, B: 0} },
		ss,
	)
