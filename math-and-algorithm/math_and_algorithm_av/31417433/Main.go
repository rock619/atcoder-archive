...
func (m Matrix) Multiply(m2 Matrix) Matrix {
	result := Matrix{
		c: [3][3]ModInt{
			{NewModInt(0, MOD), NewModInt(0, MOD), NewModInt(0, MOD)},
			{NewModInt(0, MOD), NewModInt(0, MOD), NewModInt(0, MOD)},
			{NewModInt(0, MOD), NewModInt(0, MOD), NewModInt(0, MOD)},
		},
	}
...
func solve(N int64) {
	m := Matrix{
		c: [3][3]ModInt{
			{NewModInt(1, MOD), NewModInt(1, MOD), NewModInt(1, MOD)},
			{NewModInt(1, MOD), NewModInt(0, MOD), NewModInt(0, MOD)},
			{NewModInt(0, MOD), NewModInt(1, MOD), NewModInt(0, MOD)},
		},
	}

	result := m.Power(N - 1)
	fmt.Println(result.c[0][0].V)
}
